/**
 * CaptureInputScreen Component
 * 
 * A full-screen editable notepad for creating new notes.
 * Similar to a notepad - completely editable with speak functionality.
 * Auto-saves when navigating back if there's text, otherwise no note is created.
 */
...
export function CaptureInputScreen(): React.ReactElement {
   ...
   * 
   * Auto-saves the note if there's text, otherwise just navigates back.
   */
